...
(* OASIS_START *)
(* DO NOT EDIT (digest: cac502cca88c9a66886605e4a08b3697) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Config"; "ReadMach"; "ReadElf"; "ReadPE"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "¶V\018äè>Í½\012@âxZ\141£8";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
