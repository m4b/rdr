...
(* OASIS_START *)
(* DO NOT EDIT (digest: c92652b70453f9c5b1003f2b64cb7e7e) *)
(*
...
let setup_t =
  {
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_deriving.yojson", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "Rdr.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\147X(\129%\017\189\020\017\011*\003\160\224x\019";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
