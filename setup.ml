...
(* OASIS_START *)
(* DO NOT EDIT (digest: 394a035d52984a26eaaf444b758777d2) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["m4b"];
          homepage = Some "http://github.com/m4b/rdr";
          synopsis =
          ...
          description =
            Some
              [
                 ...
                 OASISText.Verbatim " and provides other meta-data"
              ];
          categories = [];
            ...
            [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "utils"; FindlibPackage ("", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Rdr"; "RdrObject"; "SymbolMap"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "rdr";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Config"; "Graph"; "ReadMach"; "ReadElf"; "ReadPE"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "z\255\202\16514\193\005~\251\220\229\244v\244{";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
